...
ALLOTMENT = (('G', 'Government'), ("M", "Management"), ("S", "Sports Admission"))
...
class User(AbstractUser):
    ...
    caste = models.CharField(max_length=30, blank=True, null=True)
    community = models.CharField(max_length=30, blank=True, null=True)
    parent_annual_inc = models.CharField(max_length=30, blank=True, null=True)
    ...
    date_of_admission = models.CharField(max_length=30, blank=True, null=True)
    admission_allotment = models.CharField(max_length=30, choices=ALLOTMENT, blank=True, null=True)
    visa_no = models.CharField(max_length=30, blank=True, null=True)
    visa_type = models.CharField(max_length=30, blank=True, null=True)
